...
SECRET_KEY = 'django-insecure-vkvc)g)qu)ut-67t-2%yoh$z22kx(nynnkvl6pl@cbvb%882iu'
...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "derinellrojas@gmail.com")
